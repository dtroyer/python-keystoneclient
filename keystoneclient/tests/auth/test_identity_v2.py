...
class V2IdentityPlugin(utils.TestCase):
    ...
    def test_with_no_auth(self):
        a = self._plugin()
        self.assertRaises(exceptions.AuthPluginUnauthenticated, a.get_token)

    def test_with_expired(self):
        self.TEST_RESPONSE_DICT['access']['token']['expires'] = \
            '2000-01-01T00:00:10.000123Z'

        a = self._plugin()
        a.auth_ref = access.AccessInfo.factory(body=self.TEST_RESPONSE_DICT)
